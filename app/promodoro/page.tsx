...
export default function PomodoroTimer() {
    ...
    if (timer.totalSeconds === 0 && timer.isRunning) {
      ...
      setTimer((prev) => {
        ...
        if (prev.sessionType === "pomodoro") {
          ...
          nextSessionType =
            newCompletedPomodoros % 4 === 0 ? "longBreak" : "shortBreak";
        } else {
  ...
  const progressPercentage =
    ((timer.initialSeconds - timer.totalSeconds) / timer.initialSeconds) * 100;
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-2xl mx-auto space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="w-full max-w-md mx-auto">
                ...
                <div className="flex justify-between text-xs text-muted-foreground mt-2">
                  ...
                  <span>
                    {formatTime(
                      Math.floor(timer.initialSeconds / 60),
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
              ...
              <div>
                <div className="text-3xl font-bold text-green-600 mb-2">
                  {timer.completedPomodoros > 0
                    ? Math.floor(timer.completedPomodoros / 4)
                    : 0}
                </div>
                <div className="text-sm text-muted-foreground">
                  Long Breaks Taken
              ...
              <div>
                <div className="text-3xl font-bold text-blue-600 mb-2">
                  {Math.floor((timer.completedPomodoros * 25) / 60)}h{" "}
                  {(timer.completedPomodoros * 25) % 60}m
                </div>
                <div className="text-sm text-muted-foreground">
                  Total Focus Time
                </div>
        ...
        <div className="text-center text-sm text-muted-foreground space-y-2">
          <p>
            💡 <strong>Tip:</strong> Take short breaks between pomodoros and
